...
import backend_SpotifyAPI.SearchDownloader;
import backend_SpotifyAPI.Song;
import backend_SpotifyAPI.SongDownloader;
import backend_SpotifyAPI.TokenDownloader;
...
public class GuiStartController {
    ...
    public Button firstButton, secondButton, thirdButton, fourthButton, fifthButton,
    				sixthButton, seventhButton, eightButton, ninthButton, tenthButton;
    ...
    public ImageView add1, add2, add3, add4, add5, add6, add7, add8, add9, add10;
    public ImageView cover1, cover2, cover3, cover4, cover5, cover6, cover7, 
    				cover8, cover9, cover10;
    ...
    public VBox popup;
    public TextArea authInputText;
    public Label instructionL;
    ...
    public void initialize() {
    	...
    	instructionL.setWrapText(true);
    	authInputText.setWrapText(true);
    ...
    private void allocateButtons() {
        buttons = new Button[] {firstButton, secondButton, thirdButton, fourthButton, fifthButton, 
        		sixthButton, seventhButton, eightButton, ninthButton, tenthButton};
    ...
    /**
     * Have the user login into Spotify and authorize the app to use their Spotify.
     * 
    ...
    public void login(MouseEvent mouseEvent) {
    	try {
			TokenDownloader.authorizeUser();
		} catch (NoSuchAlgorithmException | IOException | URISyntaxException e) {
			System.out.println("An error occured trying to get the authorization code. Please make sure that you have internet connection and accept the app's request.");
			e.printStackTrace();
		}
    ...
    /**
     * Shows the instruction pop-up.
     * 
     * @param mouseEvent		a MouseEvent with more info about the
     * 							the player's mouse.
     */
    public void showInstruction(MouseEvent mouseEvent) {
    	instruction.setVisible(!instruction.isVisible());
    }
    
    /**
     * Hide pop-up and set the authorization code for the token downloader.
     * 
     * @param mouseEvent		a MouseEvent with more info about the
     * 							the player's mouse.
     */
    public void acceptAuthorize(MouseEvent mouseEvent) {
    	String authText = authInputText.getText();
    	if (authText != "")
    		TokenDownloader.setAuthorizeCode(authText);
    	popup.setVisible(false);
    } 
    ...
    private void playHelper() {
    	playing = true;
    	mediaPlayer.play();
    	File pause = new File("src/fxml/Pause.png");
    	Image pauseImg = new Image(pause.toURI().toString());
    	playPause.setImage(pauseImg);
    }
    ...
    private void pauseHelper() {
    	playing = false;
    	mediaPlayer.pause();
    	File play = new File("src/fxml/Play1.png");
    	Image playImg = new Image(play.toURI().toString());
    	playPause.setImage(playImg);
    }
